...
jest.mock('next/navigation', () => ({
  ...
  usePathname: jest.fn(() => '/v1/oauth2/credential/create/enforce_mfa'),
}));
...
describe('OAuth v1 EnforceMfaPage', () => {
  beforeEach(setup);
  ...
  test('navigates to enforce mfa recovery code on lost device press', () => {
    ...
    expect(mockReplace).toHaveBeenCalledWith('/v1/oauth2/credential/create/enforce_mfa_recovery_code');
  });
});
