...
export default function IconSendTransactionPage() {
  ...
  const doIconSendTransactionForUser = async () => {
    ...
    try {
      ...
      const res = await iconBridge.sendTransaction(activeRpcPayload, pk);
  ...
  useEffect(() => {
    if (multichainWalletHydrationError) {
      ...
      logger.error(
        'icx_sendTransaction Page - Error hydrating or creating multichain wallet',
