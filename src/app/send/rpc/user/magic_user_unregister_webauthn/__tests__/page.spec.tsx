import Page from '@app/send/rpc/user/magic_user_unregister_webauthn/page';
...
jest.mock('@hooks/data/embedded/webauthn', () => ({
  useUnregisterWebauthnQuery: jest.fn().mockImplementation(() => ({
...
describe('magic_user_unregister_webauthn page', () => {
  function executeRequest() {
    AtomicRpcPayloadService.setActiveRpcPayload({
      jsonrpc: '2.0',
      method: 'magic_user_unregister_webauthn',
      id: 'my_id',
      params: [{ webAuthnCredentialsId: 'webAuthnCredentialsId' }],
    });
    ...
    await waitFor(() => {
      expect(resolveJsonRpcResponse).toHaveBeenCalledWith({
        ...
        analyticsProperties: {
          ...
          env: 'test-testnet',
          eventOrigin: '',
          json_rpc_method: 'magic_user_unregister_webauthn',
          rpcUrl: 'mainnet',
          sdk: 'SdkMissing',
