import Page from '@app/send/rpc/cos/cos_signTypedData/page';
...
const mockCosmosBridge = { signTypedData: jest.fn().mockResolvedValue('signature') };
const mockCosmosBridgeError = { signTypedData: jest.fn().mockRejectedValue('error') };
...
describe('Page Component', () => {
  ...
  it('user logged in: should call resolveActiveRpcRequest with successfuly generated cosmos signature', async () => {
    ...
    await waitFor(async () => {
      ...
      expect(mockCosmosBridge.signTypedData).toHaveBeenCalledWith(mockActiveRpcPayload, 'decryptedPrivateKey');
  ...
  it('user logged in: should call rejectActiveRpcRequest if cosmos bridge throws error', async () => {
    ...
    await waitFor(async () => {
      await executeRequest();
      expect(DkmsService.reconstructSecret).toHaveBeenCalledWith(expect.anything(), mockWallet.encryptedPrivateAddress);
      expect(mockCosmosBridgeError.signTypedData).toHaveBeenCalledWith(mockActiveRpcPayload, 'decryptedPrivateKey');
