...
export default function ZilSendTransactionPage() {
  ...
  const doZilliqaSendTransactionForUser = async () => {
    ...
    try {
      ...
      const res = await zilliqaBridge.sendTransaction(activeRpcPayload, pk);
  ...
  useEffect(() => {
    ...
    doZilliqaSendTransactionForUser();
  ...
  useEffect(() => {
    if (multichainWalletHydrationError) {
      ...
      logger.error(
        'zil_sendTransaction Page - Error hydrating or creating multichain wallet',
