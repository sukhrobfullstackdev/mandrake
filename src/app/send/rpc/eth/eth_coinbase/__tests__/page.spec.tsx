import Page from '@app/send/rpc/eth/eth_coinbase/page';
...
jest.mock('@hooks/common/hydrate-or-create-wallets/hydrate-or-create-eth-wallet', () => ({
  useHydrateOrCreateEthWallet: jest.fn().mockImplementation(() => ({ isEthWalletHydrated: true })),
}));
