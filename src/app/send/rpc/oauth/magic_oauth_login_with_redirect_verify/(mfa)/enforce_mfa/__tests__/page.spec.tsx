...
import { RPC_ROUTE } from '../../../constants';
...
jest.mock('next/navigation', () => ({
  ...
  usePathname: jest.fn(() => '/send/rpc/oauth/magic_oauth_login_with_redirect_verify/enforce_mfa'),
}));
...
describe('OAuth EnforceMfaPage', () => {
  ...
  test('navigates to enforce mfa recovery code on lost device press', () => {
    ...
    expect(mockReplace).toHaveBeenCalledWith(`${RPC_ROUTE}/enforce_mfa_recovery_code`);
  });
});
