...
jest.mock('next/navigation', () => ({
  ...
  usePathname: jest.fn(() => '/send/rpc/auth/magic_auth_login_with_sms/enforce_mfa'),
}));
...
describe('EnforceMfaPage', () => {
  ...
  test('navigates to enforce mfa recovery code on lost device press', () => {
    ...
    expect(mockReplace).toHaveBeenCalledWith('/send/rpc/auth/magic_auth_login_with_sms/enforce_mfa_recovery_code');
  });
});
