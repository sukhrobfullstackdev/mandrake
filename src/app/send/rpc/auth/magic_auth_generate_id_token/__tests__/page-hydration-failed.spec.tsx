import Page from '@app/send/rpc/auth/magic_auth_generate_id_token/page';
...
jest.mock('next/navigation', () => ({
  ...
  usePathname: jest.fn(() => '/send/rpc/auth/magic_auth_generate_id_token'),
}));
...
describe('magic_auth_generate_id_token page', () => {
  ...
  it('when hydration fails a user denied account access should be posted back', () => {
